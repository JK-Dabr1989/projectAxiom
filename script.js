(() => {
  ...
  const translations = {
    pl: {
      ...
      "Project Axiom": "Project Axiom",
      "Edinburgh": "Edynburg",
      "Tester / Edinburgh": "Tester / Edynburg",
      "Tester 01": "Tester 01",
      "Edinburgh, Scotland": "Edynburg, Szkocja",
      "First External Tester": "Pierwszy tester zewnętrzny",
      "What we learned from our first external home test": "Czego nauczył nas pierwszy zewnętrzny test domowy",
      "Every opinion here comes from real people using pre-release hardware in their own kitchens. This wasn't a polished product demonstration. It was an opportunity to understand where the system creates value, where it creates friction, and what should change before the next iteration.": "Każda opinia pochodzi od prawdziwych osób używających przedpremierowego sprzętu we własnych kuchniach. To nie był dopracowany pokaz produktu. To była okazja, by zrozumieć, gdzie system daje wartość, gdzie tworzy tarcie i co powinno zmienić się przed następną iteracją.",
      "What worked": "Co zadziałało",
      "NFC made food logging enjoyable": "NFC sprawiło, że zapisywanie jedzenia stało się przyjemniejsze",
      "The interactiveness that the NFC provide is engaging and it provides a 'game' factor to logging food making you want to use it more.": "Interaktywność, którą daje NFC, angażuje i dodaje zapisywaniu jedzenia element gry, przez co chce się korzystać z niego częściej.",
      "This was the strongest recurring theme throughout testing.": "To był najmocniejszy motyw powracający w całych testach.",
      "Rather than feeling like another nutrition app, the physical interaction encouraged repeated use. The tester specifically suggested pushing this idea even further in future versions.": "Zamiast sprawiać wrażenie kolejnej aplikacji żywieniowej, fizyczna interakcja zachęcała do ponownego użycia. Tester wyraźnie zasugerował, żeby w kolejnych wersjach pójść z tym pomysłem jeszcze dalej.",
      "The concept has potential": "Koncepcja ma potencjał",
      "Although the tester chose not to continue with the current prototype, they expressed interest in testing future versions and said they would probably want the system back if it disappeared.": "Chociaż tester nie zdecydował się kontynuować pracy z obecną wersją prototypu, wyraził zainteresowanie testowaniem kolejnych wersji i powiedział, że prawdopodobnie chciałby odzyskać system, gdyby zniknął.",
      "For an early hardware prototype, that's encouraging.": "Jak na wczesny prototyp sprzętowy, to zachęcający sygnał.",
      "Where we fell short": "Gdzie prototyp nie wystarczył",
      "The current prototype did not replace existing food logging workflows.": "Obecny prototyp nie zastąpił istniejących sposobów zapisywania jedzenia.",
      "The tester felt that traditional scales and existing nutrition applications remained faster and more intuitive.": "Tester uznał, że tradycyjne wagi i istniejące aplikacje żywieniowe nadal są szybsze i bardziej intuicyjne.",
      "Using a traditional scale is less time consuming overall, and pre-defined recipes on the app are more intuitive to use...": "Korzystanie z tradycyjnej wagi zajmuje ogólnie mniej czasu, a gotowe przepisy w aplikacji są bardziej intuicyjne...",
      "This wasn't unexpected.": "Nie było to zaskoczeniem.",
      "People already have years of experience using conventional kitchen scales. Replacing habits requires more than working hardware - it requires a workflow that is genuinely faster.": "Ludzie mają już lata doświadczenia w używaniu zwykłych wag kuchennych. Zastąpienie nawyków wymaga czegoś więcej niż działającego sprzętu - wymaga procesu, który naprawdę jest szybszy.",
      "Technical issues discovered": "Wykryte problemy techniczne",
      "During this test we identified two significant prototype issues.": "Podczas tego testu wykryliśmy dwa istotne problemy prototypu.",
      "NFC reliability occasionally prevented Recipe Tags and Passive Logging from functioning consistently.": "Niezawodność NFC czasami uniemożliwiała stabilne działanie tagów przepisów i pasywnego zapisywania.",
      "Bluetooth synchronisation exposed stability problems that required further investigation.": "Synchronizacja Bluetooth ujawniła problemy ze stabilnością, które wymagały dalszego sprawdzenia.",
      "Both issues were addressed immediately after the testing period and became priorities for the following hardware and firmware revisions.": "Oba problemy zostały zaadresowane od razu po okresie testowym i stały się priorytetami dla kolejnych zmian sprzętu oraz firmware'u.",
      "What changed because of this feedback": "Co zmieniło się dzięki tej opinii",
      "This test directly influenced the roadmap.": "Ten test bezpośrednio wpłynął na roadmapę.",
      "Increased NFC reliability.": "Zwiększenie niezawodności NFC.",
      "Investigation into Bluetooth synchronisation stability.": "Sprawdzenie stabilności synchronizacji Bluetooth.",
      "Greater focus on making NFC interactions feel rewarding rather than simply functional.": "Większy nacisk na to, by interakcje NFC były satysfakcjonujące, a nie tylko funkcjonalne.",
      "Continued effort to reduce friction so the scale becomes faster than traditional logging methods.": "Dalsza praca nad ograniczaniem tarcia, aby waga stała się szybsza od tradycyjnych metod zapisywania.",
      "Overall takeaway": "Główny wniosek",
      "The most valuable outcome wasn't discovering that the prototype needed improvement.": "Najcenniejszym wynikiem nie było odkrycie, że prototyp wymaga poprawy.",
      "It was discovering why people kept reaching for it.": "Było nim zrozumienie, dlaczego ludzie mimo wszystko po niego sięgali.",
      "The tester repeatedly described the NFC interaction as engaging and enjoyable - something existing kitchen scales simply don't offer. At the same time, they reminded us that novelty alone isn't enough. To become part of someone's daily routine, the experience must also be faster and more intuitive than the tools they're already using.": "Tester wielokrotnie opisywał interakcję NFC jako angażującą i przyjemną - jako coś, czego zwykłe wagi kuchenne po prostu nie oferują. Jednocześnie przypomniał nam, że sama nowość nie wystarczy. Aby wejść do czyjejś codziennej rutyny, doświadczenie musi być też szybsze i bardziej intuicyjne niż narzędzia, których ta osoba już używa.",
      "That's exactly what the next iterations are focused on.": "Właśnie na tym skupiają się kolejne iteracje.",
      "Read the original tester feedback": "Przeczytaj oryginalną opinię testera",
      "The complete survey response is available below. The tester's identity and document metadata have been removed, but the submitted answers have not been rewritten.": "Pełna odpowiedź z ankiety jest dostępna poniżej. Tożsamość testera i metadane dokumentu zostały usunięte, ale przesłane odpowiedzi nie zostały przepisane ani wygładzone.",
      "Download anonymised tester report": "Pobierz zanonimizowany raport testera",
      "Download anonymised tester report for Tester 01": "Pobierz zanonimizowany raport testera 01",
      ...
      "Tester 01 | Tester Insights | Project Axiom": "Tester 01 | Wnioski z testów | Project Axiom",
